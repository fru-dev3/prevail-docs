...
The architecture and storage rule also live alongside the source, in [`ARCHITECTURE.md`](https://github.com/fru-dev3/prevail-docs/blob/main/ARCHITECTURE.md) and the engine contract in [`docs/ENGINE-JSON-API.md`](https://github.com/fru-dev3/prevail-cli/blob/main/docs/ENGINE-JSON-API.md).
