...
<Aside type="caution">
Read [`docs/threat-model.md`](https://github.com/fru-dev3/prevail-cli/blob/main/docs/threat-model.md) before exposing either the MCP server or the Telegram bridge to anything other than your own laptop.
</Aside>
...
Security issues go through the process in [`SECURITY.md`](https://github.com/fru-dev3/prevail-cli/blob/main/SECURITY.md). Please don't open a public issue for a sensitive report.
